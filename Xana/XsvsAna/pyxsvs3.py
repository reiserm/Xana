...
def pyxsvs( data, qroi, nbins=15, t_e=1., qv=None, method='full', nprocs=1,
            verbose=1, qsec=(0,0)):
    ...
    if verbose:
        ...
        print('Elapsed time for calulating probabilities: {:.2f} min'.format(tcalc_cum/60.))

    probd = {'prob':prob, 't_exposure':t_e, 'trace':trace, 'qv':qv, 'qroi':qroi,}
